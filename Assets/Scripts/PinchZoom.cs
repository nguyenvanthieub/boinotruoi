...
public class PinchZoom : MonoBehaviour 
{
	...
	void Start () 
	{
		// Game Object will be created and make current object as its child 
		//(only because we can set virtual anchor point of gameobject and can zoom in and zoom out from particular position)
